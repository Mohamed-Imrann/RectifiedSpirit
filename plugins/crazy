...
import io # For handling file-like objects for document sending
...
async def view_user_state(client: Client, message: Message):
    user_id = message.from_user.id
    user_state = temp_admin_data.get(user_id)
    if user_state:
