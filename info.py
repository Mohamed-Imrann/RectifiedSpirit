...
BOT_TOKEN = environ.get('BOT_TOKEN', '5883096902:AAF-tI_T-F_zVI4oIANJPuZxDsvskqmAw6A')
BOT_USERNAME = environ.get('BOT_USERNAME', 'MC_MovieBetaBot')
#API_ID2 = environ.get('API_ID2')
#API_HASH2 = environ.get('API_HASH2')
#SESSION_STRING = environ.get('SESSION_STRING')

# Required Database and Channel Settings
DATABASE_URI = environ.get('DATABASE_URI', 'mongodb+srv://seriesx:seriesx@cluster0.w8lzf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
DATABASE_NAME = environ.get('DATABASE_NAME', 'cluster0')
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'thernello_unda')
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001593500302')
DB_CHANNEL = [int(ch.strip()) for ch in environ.get('DB_CHANNEL', '-1001306691782 -1002193376815').split()]
RAW_DB_CHANNEL = [int(ch.strip()) for ch in environ.get('RAW_DB_CHANNEL', '1306691782 2193376815').split()]
IMGBB_API_KEY = environ.get('IMGBB_API_KEY', 'e74d34d56644c5a9543019e408dbd891')
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwZjY0ZTY1MDRhYTZkY2JkNmQxMWMzMjRiZTU3MGFmYSIsIm5iZiI6MTc1MTk3MDQyMy4zNTAwMDAxLCJzdWIiOiI2ODZjZjI3N2ZmMzFhNDFhNDhlN2ZlNTMiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.dI7SXasXd9LfTedzTfZAW05gQPcOD7_TpEMHKCGNdvU')
...
MAX_LIST_ELM = int(environ.get('MAX_LIST_ELM', '8'))
